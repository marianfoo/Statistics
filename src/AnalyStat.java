...
public class AnalyStat extends JPanel implements ActionListener {
    ...
    public AnalyStat() {
		...
		eingabePanel = new EntryFields(2,5);
		...
		welcome.StandField.setText("Das ist Analysierende Statistik");
